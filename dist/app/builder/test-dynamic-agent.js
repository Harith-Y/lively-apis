...
function testDynamicAgent() {
    return __awaiter(this, void 0, void 0, function () {
        var apiAnalyzer, parsedAPI, planner, plan, functionCalls, apiCredentials, results;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, planner.planAgent('Send the lowest stock items from Shopify to my mail')];
                case 2:
                    plan = _a.sent();
                    functionCalls = [
                        {
                    ...
                    apiCredentials = { apiKey: 'demo', token: 'demo' };
                    return [4 /*yield*/, (0, ai_integration_1.executeAgentFunctionCalls)(functionCalls, parsedAPI, apiCredentials)];
                case 3:
                    results = _a.sent();
                    // 6. Show the results
